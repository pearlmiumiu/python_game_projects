...
def spawn_ball(direction):
    ...
    ball_vel=[random.randrange(2,4),random.choice([-3,-2,-1,1,2,3])]
    if direction==RIGHT:
...
def draw(canvas):
    ...
    canvas.draw_polygon([[WIDTH, paddle2_pos[1]+HALF_PAD_HEIGHT],
                         [WIDTH, paddle2_pos[1]-HALF_PAD_HEIGHT],
                         [WIDTH-PAD_WIDTH, paddle2_pos[1]-HALF_PAD_HEIGHT],
                         [WIDTH-PAD_WIDTH, paddle2_pos[1]+HALF_PAD_HEIGHT]],
                         6, 'YELLOW')
    
    canvas.draw_text(str(score1),(WIDTH/2-70,40),18,"Red")
    canvas.draw_text(str(score2),(WIDTH/2+20,40),18,"Red")
